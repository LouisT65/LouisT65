...
function NachlassUndWohnungFunc(){
    const button = document.querySelector('.NachlassUndWohnung-button');
    let description = document.querySelector('.NachlassUndWohnung-description');
